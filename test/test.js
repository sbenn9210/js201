...
function moduleName(f) {
  return f.replace("exercises/", modulesDir).replace(".js", ".module.js");
}
...
function getFnBody(body, fnName) {
  for (let i = 0; i < body.length; i++) {
    if (body[i].type === "FunctionDeclaration" && body[i].id.name === fnName) {
      return body[i].body;
    }
  }
...
function checkForFunction(filename, theirModule, fnName) {
  it(filename + ' should contain a function "' + fnName + '"', function() {
    assert(
      isFn(theirModule[fnName]),
      'function "' + fnName + '" not found in exercises/' + filename
    );
  });
}
...
function checkHelloWorlds() {
  ...
  it('"helloDefault" function implementation', function() {
    assert.deepStrictEqual(
      module.helloDefault("Mustache"),
      "Hello, Mustache!",
      "helloDefault('Mustache') should return 'Hello, Mustache!'"
    );
    assert.deepStrictEqual(
      module.helloDefault(""),
      "Hello, world!",
      "helloDefault('') should return 'Hello, world!'"
    );
  });
}
...
function checkTipCalculator() {
  ...
  it('"tipAmount" function implementation', function() {
    assert.deepStrictEqual(
      module.tipAmount(100, "good"),
      20,
      "tipAmount(100, 'good') should return 20"
    );
    assert.deepStrictEqual(
      module.tipAmount(40, "fair"),
      6,
      "tipAmount(40, 'fair') should return 6"
    );
    assert.deepStrictEqual(
      module.tipAmount(30, "poor"),
      3,
      "tipAmount(30, 'poor') should return 3"
    );
  });
  ...
  it('"totalAmount" function implementation', function() {
    assert.deepStrictEqual(
      module.totalAmount(100, "good"),
      120,
      "totalAmount(100, 'good') should return 120"
    );
    assert.deepStrictEqual(
      module.totalAmount(40, "fair"),
      46,
      "totalAmount(40, 'fair') should return 46"
    );
    assert.deepStrictEqual(
      module.totalAmount(30, "poor"),
      33,
      "totalAmount(30, 'poor') should return 33"
    );
  });
  ...
  it('"splitAmount" function implementation', function() {
    assert.deepStrictEqual(
      module.splitAmount(100, "good", 5),
      24,
      "splitAmount(100, 'good', 5) should return 24"
    );
    assert.deepStrictEqual(
      module.splitAmount(40, "fair", 2),
      23,
      "splitAmount(40, 'fair', 2) should return 23"
    );
    assert.deepStrictEqual(
      module.splitAmount(30, "poor", 3),
      11,
      "splitAmount(30, 'poor', 3) should return 11"
    );
  });
}
...
function checkPredicateFunctions() {
  ...
  const moduleFileName =
    "../" + moduleName("exercises/208-predicate-functions.js");
  let module = getModule(moduleFileName);
  ...
  it('"isVowel" function implementation', function() {
    ...
    assert.deepStrictEqual(
      module.isVowel(99),
      false,
      "isVowel(99) should return false"
    );
    assert.deepStrictEqual(
      module.isVowel({}),
      false,
      "isVowel({}) should return false"
    );
    assert.deepStrictEqual(
      module.isVowel("Ez"),
      false,
      "isVowel('Ez') should return false"
    );
    assert.deepStrictEqual(
      module.isVowel("aa"),
      false,
      "isVowel('aa') should return false ('aa' is not a character)"
    );
  });
  ...
  it('"isEven" function implementation', function() {
    ...
    assert.deepStrictEqual(
      module.isEven(1000),
      true,
      "isEven(1000) should return true"
    );
    assert.deepStrictEqual(
      module.isEven(99),
      false,
      "isEven(99) should return false"
    );
    assert.deepStrictEqual(
      module.isEven("banana"),
      false,
      "isEven('banana') should return false"
    );
    assert.deepStrictEqual(
      module.isEven("8"),
      false,
      'isEven("8") should return false ("8" is a string)'
    );
    assert.deepStrictEqual(
      module.isEven([]),
      false,
  ...
  it('"isOdd" function implementation', function() {
    ...
    assert.deepStrictEqual(
      module.isOdd(100),
      false,
      "isOdd(100) should return false"
    );
    assert.deepStrictEqual(
      module.isOdd(3.14),
      false,
      "isOdd(3.14) should return false"
    );
    assert.deepStrictEqual(
      module.isOdd("13"),
      false,
      'isOdd("13") should return false ("13" is a string)'
    );
    assert.deepStrictEqual(
      module.isOdd({}),
      false,
  ...
  it('"isCapitalCity" function implementation', function() {
    assert.deepStrictEqual(
      module.isCapitalCity("Texas", "Austin"),
      true,
      "isCapitalCity('Texas', 'Austin') should return true"
    );
    assert.deepStrictEqual(
      module.isCapitalCity("Texas", "Houston"),
      false,
      "isCapitalCity('Texas', 'Houston') should return false"
    );
    assert.deepStrictEqual(
      module.isCapitalCity("Alaska", "Juneau"),
      true,
      "isCapitalCity('Alaska', 'Juneau') should return false"
    );
    assert.deepStrictEqual(
      module.isCapitalCity("Strawberry", "Mango"),
      false,
      "isCapitalCity('Strawberry', 'Mango') should return false"
    );
  });
}
...
function checkFizzbuzz() {
  ...
  it('"fizzbuzz" function implementation', function() {
    ...
    assert.deepStrictEqual(
      module.fizzbuzz(15),
      "..fizz.buzzfizz..fizzbuzz.fizz..fizzbuzz",
      "fizzbuzz(15) should return '..fizz.buzzfizz..fizzbuzz.fizz..fizzbuzz'"
    );
  });
}
...
function checkNumberJoiners() {
  ...
  it('"numberJoinerFancy" function implementation', function() {
    ...
    assert.deepStrictEqual(
      module.numberJoinerFancy(1, 1),
      "1",
      "numberJoinerFancy(1, 1) should return '1'"
    );
    assert.deepStrictEqual(
      module.numberJoinerFancy(-2, 3, "xx"),
      "-2xx-1xx0xx1xx2xx3",
...
function checkLoopyStrings() {
  ...
  it('"reverse" function implementation', function() {
    assert.deepStrictEqual(
      module.reverse("skoob"),
      "books",
      "reverse('skoob') should return 'books'"
    );
    assert.deepStrictEqual(
      module.reverse("1234"),
      "4321",
    ...
    assert.deepStrictEqual(
      module.reverse("blah blah"),
      "halb halb",
      "reverse('blah blah') should return 'halb halb'"
    );
  });
  ...
  it('"findLongestWord" function implementation', function() {
    assert.deepStrictEqual(
      module.findLongestWord("a book full of dogs"),
      "book",
      "findLongestWord('a book full of dogs') should return 'book"
    );
    assert.deepStrictEqual(
      module.findLongestWord("abrakadabra is the longest word here"),
      "abrakadabra",
      "findLongestWord('abrakadabra is the longest word here') should return 'abrakadabra'"
    );
    assert.deepStrictEqual(
      module.findLongestWord("word"),
      "word",
      "findLongestWord('word') should return 'word'"
    );
  });
  ...
  it('"nicer" function implementation', function() {
    assert.deepStrictEqual(
      module.nicer("mom get the heck in here and bring me a darn sandwich."),
      "mom get the in here and bring me a sandwich.",
      "nicer('mom get the heck in here and bring me a darn sandwich.') should return 'mom get the in here and bring me a sandwich.'"
    );
    assert.deepStrictEqual(
      module.nicer("only nice things"),
      "only nice things",
      "module.nicer('only nice things') should return 'only nice things"
    );
    assert.deepStrictEqual(
      module.nicer("a crappy thing"),
      "a thing",
      "nicer('a crappy thing') should return 'a thing"
    );
  });
  ...
  it('"capitalizeAll" function implementation', function() {
    assert.deepStrictEqual(
      module.capitalizeAll("hello world"),
      "Hello World",
      "capitalizeAll('hello world') should return 'Hello World'"
    );
    assert.deepStrictEqual(
      module.capitalizeAll("a"),
      "A",
      "capitalizeAll('a') should return 'A'"
    );
  });
  ...
  it('"split" function implementation', function() {
    assert.deepStrictEqual(
      module.split("a-b-c", "-"),
      ["a", "b", "c"],
      "split('a-b-c', '-') should return['a', 'b', 'c'] "
    );
    assert.deepStrictEqual(
      module.split("APPLExxBANANAxxCHERRY", "xx"),
      ["APPLE", "BANANA", "CHERRY"],
      "split('APPLExxBANANAxxCHERRY', 'xx') should return ['APPLE', 'BANANA', 'CHERRY']"
    );
    assert.deepStrictEqual(
      module.split("xyz", "r"),
      ["xyz"],
      "split('xyz', 'r') should return ['xyz']"
    );
  });
}
...
function checkFactors() {
  ...
  it('"factors" function implementation', function() {
    ...
    assert.deepStrictEqual(
      module.factors(37),
      [1, 37],
      "factors(37) should return [1, 37]"
    );
    assert.deepStrictEqual(
      module.factors(48),
      [1, 2, 3, 4, 6, 8, 12, 16, 24, 48],
      "factors(48) should return [1, 2, 3, 4, 6, 8, 12, 16, 24, 48]"
    );
    assert.deepStrictEqual(
      module.factors(96),
      [1, 2, 3, 4, 6, 8, 12, 16, 24, 32, 48, 96],
      "factors(96) should return [1, 2, 3, 4, 6, 8, 12, 16, 24, 32, 48, 96]"
    );
  });
}
...
function checkCities() {
  ...
  it('"cityNames" function implementation', function() {
    assert.deepStrictEqual(
      ...
      ["Los Angeles", "Atlanta", "Detroit", "New York"],
      "coolCities([\n" +
        "      { name: 'Los Angeles', temperature: 60.0},\n" +
        "      { name: 'Atlanta', temperature: 52.0 },\n" +
        "      { name: 'Detroit', temperature: 48.0 },\n" +
...
function checkLongLongVowels() {
  ...
  const moduleFileName =
    "../" + moduleName("exercises/230-long-long-vowels.js");
  let module = getModule(moduleFileName);
...
function checkNumberArrays() {
  ...
  it('"max" function implementation', function() {
    ...
    assert.deepStrictEqual(
      module.max([-1000, 20, 32, 0]),
      32,
      "max([-1000,20,32,0]) should return 32"
    );
  ...
  it('"sumNumbers" function implementation', function() {
    ...
    assert.deepStrictEqual(
      module.sumNumbers([88]),
      88,
      "sumNumbers([88]) should return 88"
    );
    assert.deepStrictEqual(
      module.sumNumbers([1, 4, 8]),
      13,
      "sumNumbers([1, 4, 8]) return 13"
    );
    assert.deepStrictEqual(
      module.sumNumbers([1, 4, 8, 1, 4, 8, 1, 4, 8]),
      39,
      "sumNumbers([1, 4, 8, 1, 4, 8, 1, 4, 8]) should return 39"
    );
  ...
  it('"positives" function implementation', function() {
    assert.deepStrictEqual(
      module.positives([-1, -2, -3, 4, 5]),
      [4, 5],
      "positives([-1, -2, -3, 4, 5]) should return [4,5]"
    );
    assert.deepStrictEqual(
      module.positives([-1, -2, -3, -4, -5]),
      [],
      "positives([-1, -2, -3, -4, -5]) should return []"
    );
    assert.deepStrictEqual(
      module.positives([-1, -2, -3, 0, 1000]),
      [1000],
      "positives([-1, -2, -3, 1000]) should return [1000]"
    );
    assert.deepStrictEqual(
      module.positives([]),
      [],
      "positives([]) should return []"
    );
    assert.deepStrictEqual(
      module.positives([1, -3, 5, -3, 0]),
      [1, 5],
      "positives([1, -3, 5, -3, 0]) should return [1, 5]"
    );
    assert.deepStrictEqual(
      module.positives([1, 2, 3]),
      [1, 2, 3],
      "positives([1, 2, 3]) should return [1, 2, 3]"
    );
    assert.deepStrictEqual(
      module.positives([-1, -4, -8]),
      [],
      "positives([-1, -4, -8]) should return []"
    );
    assert.deepStrictEqual(
      module.positives([-1, -4, -8, 8]),
      [8],
      "positives([-1, -4, -8, 8]) should return [8]"
    );
  });
  ...
  it('"evens" function implementation', function() {
    assert.deepStrictEqual(
      module.evens([1, 2, 3, 4, 5]),
      [2, 4],
      "evens([1,2,3,4,5]) should return [2,4]"
    );
    assert.deepStrictEqual(
      module.evens([2, 4, 6, 7, 8]),
      [2, 4, 6, 8],
      "evens([2,4,6,7,8]) should return [2,4,6,8]"
    );
    assert.deepStrictEqual(
      module.evens([-2, -4, -6, -7, -8]),
      [-2, -4, -6, -8],
  ...
  it('"odds" function implementation', function() {
    assert.deepStrictEqual(
      module.odds([1, 2, 3, 4, 5]),
      [1, 3, 5],
      "odds([1,2,3,4,5]) should return [1,3,5]"
    );
    assert.deepStrictEqual(
      module.odds([2, 4, 6, 7, 8]),
      [7],
      "odds([2,4,6,7,8]) should return [7]"
    );
    assert.deepStrictEqual(
      module.odds([-2, -4, -6, -7, -8]),
      [-7],
  ...
  it('"integers" function implementation', function() {
    assert.deepStrictEqual(
      module.integers([3.14, 2.4, 7, 8.1, 2]),
      [7, 2],
      "integers([3.14, 2.4, 7, 8.1, 2]) should return [7, 2]"
    );
    assert.deepStrictEqual(
      module.integers([3.14, 2.4, -7, 8.1, -2]),
      [-7, -2],
    ...
    assert.deepStrictEqual(
      module.integers([3.14, 2.4, 8.1, 0]),
      [0],
      "integers([3.14, 2.4, 8.1, 0]) should return [0]"
    );
  });
  ...
  it('"squareDance" function implementation', function() {
    assert.deepStrictEqual(
      module.squareDance([]),
      [],
      "squareDance([]) should return []"
    );
    assert.deepStrictEqual(
      module.squareDance([1]),
      [1],
      "squareDance([1]) should return [1]"
    );
    assert.deepStrictEqual(
      module.squareDance([1, 2, 3]),
      [1, 4, 9],
      "squareDance([1,2,3]) should return [1,4,9]"
    );
  });
}
...
function checkRockPaperScissors() {
  ...
  const moduleFileName =
    "../" + moduleName("exercises/211-rock-paper-scissors.js");
  let module = getModule(moduleFileName);

  checkForFunction(filename, module, "rockPaperScissors");
  it('"rockPaperScissors" function implementation', function() {
    assert.deepStrictEqual(
      module.rockPaperScissors("rock", "scissors"),
      "player 1"
    );
    assert.deepStrictEqual(
      module.rockPaperScissors("paper", "rock"),
      "player 1"
    );
    assert.deepStrictEqual(
      module.rockPaperScissors("scissors", "paper"),
      "player 1"
    );

    assert.deepStrictEqual(
      module.rockPaperScissors("scissors", "rock"),
      "player 2"
    );
    assert.deepStrictEqual(
      module.rockPaperScissors("rock", "paper"),
      "player 2"
    );
    assert.deepStrictEqual(
      module.rockPaperScissors("paper", "scissors"),
      "player 2"
    );
    ...
    assert.deepStrictEqual(
      module.rockPaperScissors("scissors", "scissors"),
      "draw"
    );
  });
}
...
function checkLeetspeak() {
  ...
  it('"leetspeak" function implementation', function() {
    assert.deepStrictEqual(
      module.leetspeak("banana"),
      "b4n4n4",
      "leetspeak('banana') should return 'b4n4n4'"
    );
    assert.deepStrictEqual(
      module.leetspeak("kewl"),
      "k3wl",
      "leetspeak('kewl') should return 'k3wl'"
    );
    assert.deepStrictEqual(
      module.leetspeak("orange"),
      "0r4n63",
      "leetspeak('orange') should return '0r4n63'"
    );
    assert.deepStrictEqual(
      module.leetspeak("ORANGE"),
      "0r4n63",
    ...
    assert.deepStrictEqual(
      module.leetspeak("Leet"),
      "l337",
      "leetspeak('Leet') should return 'l337'"
    );
    assert.deepStrictEqual(
      module.leetspeak("page"),
      "p463",
      "leetspeak('page') should return 'p463'"
    );
    assert.deepStrictEqual(
      module.leetspeak("silly"),
      "51lly",
      "leetspeak('silly') should return '51lly'"
    );
    assert.deepStrictEqual(
      module.leetspeak(""),
      "",
      "leetspeak('') should return '' (an empty string)"
    );
  });
}
...
function checkCaesarCipher() {
  ...
  it('"cipher" function implementation', function() {
    assert.deepStrictEqual(
      module.cipher("genius without education is like silver in the mine", 5),
      "ljsnzx bnymtzy jizhfynts nx qnpj xnqajw ns ymj rnsj"
    );
    assert.deepStrictEqual(
      module.cipher("we hold these truths to be self-evident", 8),
  ...
  it('"decipher" function implementation', function() {
    assert.deepStrictEqual(
      module.decipher("cvvcem cv fcyp!", 2),
      "attack at dawn!"
    );
    assert.deepStrictEqual(
      module.decipher("ehz czlod otgpcrpo ty l hzzo", 11),
...
function checkMakeBoxes() {
  ...
  it('"makeSquare" function implementation', function() {
    assert.deepStrictEqual(
      module.makeSquare(0),
      "",
      "makeSquare(0) should return '' (an empty string)"
    );
    assert.deepStrictEqual(
      module.makeSquare(1),
      "*",
      "makeSquare(1) should return '*'"
    );
    assert.deepStrictEqual(
      module.makeSquare(2),
      "**\n**",
  ...
  it('"makeBox" function implementation', function() {
    assert.deepStrictEqual(
      module.makeBox(0, 0),
      "",
      "makeBox(0, 0) should return '' (an empty string)"
    );
    assert.deepStrictEqual(
      module.makeBox(1, 1),
      "*",
      "makeBox(1, 1) should return '*'"
    );
    assert.deepStrictEqual(
      module.makeBox(2, 1),
      "**",
      "makeBox(2, 1) should return '**'"
    );
    assert.deepStrictEqual(
      module.makeBox(3, 2),
      "***\n***",
  ...
  it('"makeBanner" function implementation', function() {
    ...
    assert.deepStrictEqual(
      module.makeBanner("Welcome to DigitalCrafts"),
      "****************************\n" +
...
function checkRecognizeEmployees() {
  ...
  it('"recognizeEmployees" function implementation', function() {
    ...
    assert.deepStrictEqual(
      module.recognizeEmployees(
        ["Susan", "Anthony", "Bill"],
        ["Bill", "Susan"]
      ),
      [
        "Outstanding job, Susan!",
        "Great job, Anthony!",
...
function checkSortArrays() {
  ...
  it('"alphaSort" function implementation', function() {
    assert.deepStrictEqual(
      module.alphaSort(["b", "a", "c"]),
      ["a", "b", "c"],
      "sortingOne(['b', 'a', 'c']) should equal ['a', 'b', 'c']"
    );

    assert.deepStrictEqual(
      module.alphaSort(["wxy", "wxyz", "bac", "cab", "abc"]),
  ...
  it('"strLengthSort" function implementation', function() {
    assert.deepStrictEqual(
      module.strLengthSort(["one", "two", "three", "four", "no", "more"]),
...
function checkCallNTimes() {
  ...
  it('"callNTimes" function implementation', function() {
    ...
    assert.deepStrictEqual(
      count1,
      21,
      '"callNTimes(21, fn)" should execute "fn" 21 times'
    );
    assert.deepStrictEqual(
      count2,
      112,
      '"callNTimes(112, fn)" should execute "fn" 112 times'
    );
  });
}
